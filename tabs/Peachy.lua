...
function Peachy:init(x)
    ...
    levelOne = Button("Dropbox:number1Teal", vec2(256, 512))
    levelTwo = Button("Dropbox:number2Teal", vec2(512, 512))
    levelThree = Button("Dropbox:number3Teal", vec2(768, 512))
    levelFour = Button("Dropbox:number4Teal", vec2(341, 256))
    levelFive = Button("Dropbox:number5Teal", vec2(682, 256))  
end
