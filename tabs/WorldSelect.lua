...
function WorldSelect:init(x)
    ...
    sprite("Dropbox:candylandWorld")
    moveIceberg = Button("Dropbox:icebergWorld", vec2(170, HEIGHT/2))
    moveCandyland = Button("Dropbox:candylandWorld", vec2(340, HEIGHT/2))
    moveStormy = Button("Dropbox:worldStormy", vec2(510, HEIGHT/2))
    movePeachy = Button("Dropbox:peachyWorld", vec2(680, HEIGHT/2))
    moveStargaze = Button("Dropbox:stargazeWorld", vec2(850, HEIGHT/2))
